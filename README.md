...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A social media application focused on recipe sharing, user profiles, posts, likes, comments, authentication, and secure access flows.</p>
    ...
    <td width="50%" valign="top">
      ...
      <p>A full-stack platform where veterinarians can share animal case findings, treatments, posts, images, and discussions.</p>
      <p><strong>Tech Stack:</strong><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A Java Spring Boot application for managing patients, doctors, clinics, appointments, and email notifications.</p>
      <p><strong>Tech Stack:</strong><br>
    ...
    <td width="50%" valign="top">
      ...
      <p>A micro social platform with user profiles, posts, groups, comments, privacy settings, authentication, and moderation features.</p>
      <p><strong>Tech Stack:</strong><br>
      ...
      <p>🔗 <a href="https://github.com/Lung-Alexandra/Micro.Social.Platform">Repository</a></p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>A cybersecurity-focused repository covering operating systems security concepts and exploitation techniques such as virtual memory, buffer overflows, shellcoding, Return2Libc, ROP, ASLR/PIE, stack canaries, and related low-level security topics.</p>
      <p><strong>Tech Stack:</strong><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A repository for cybersecurity competition practice, including automation scripts and problem-solving approaches for web, crypto, pwn, and security challenges.</p>
      <p><strong>Tech Stack:</strong><br>
      Python · Linux · cybersecurity tools</p>
      <p><strong>Highlights:</strong></p>
      <ul>
        <li>CTF participation and write-ups</li>
        <li>Python scripts for automation and data processing</li>
        <li>Crypto and pwn challenge solving</li>
        <li>Security-focused problem solving</li>
        <li>Practice on sandboxed vulnerable environments</li>
      </ul>
      <p>🔗 <a href="https://github.com/Lung-Alexandra/ctf">Repository</a></p>
    </td>
  </tr>
</table>
...
A custom memory allocator implemented in C, designed to explore how dynamic memory allocation works under the hood. The project focuses on heap management concepts, pointer operations, memory blocks, allocation/deallocation logic, and low-level systems programming.
